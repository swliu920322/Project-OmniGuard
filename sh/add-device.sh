#!/bin/bash
# file: sh/add-device.sh
set -e

DEVICE_ID=$1
HUB_NAME="iot-omni-2ldbii7jgilfq" # 你的真实 Hub 名称
...
ENV_FILE="src/cloud-orchestrator/edge-simulator/.env"
...
python -c "
import json, os
path = 'src/cloud-orchestrator/local.settings.json'
